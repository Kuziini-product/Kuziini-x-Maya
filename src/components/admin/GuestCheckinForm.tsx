      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            <UserPlus className="absolute left-3 top-2.5 w-4 h-4 text-black/30" />
            <input
              type="text"
              value={name}
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <div className="relative">
              <Phone className="absolute left-3 top-2.5 w-4 h-4 text-black/30" />
              <input
                type="tel"
                value={phone}
          ...
          <div>
            ...
            <div className="relative">
              <Mail className="absolute left-3 top-2.5 w-4 h-4 text-black/30" />
              <input
                type="email"
                value={email}
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <div className="relative">
              <Calendar className="absolute left-3 top-2.5 w-4 h-4 text-black/30" />
              <input
                type="date"
                value={stayStart}
        ...
        <div>
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              <Umbrella className="absolute left-3 top-2.5 w-4 h-4 text-black/30" />
              <input
                type="text"
                value={loungerId}
        ...
        <div>
          ...
          <div className="relative">
            <StickyNote className="absolute left-3 top-2.5 w-4 h-4 text-black/30" />
            <textarea
              value={notes}
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-end">
          <div className="bg-white w-full max-h-[80vh] overflow-y-auto p-4 rounded-t-2xl">
            <div className="flex items-center justify-between mb-4">
              <p className="text-[#1a1a1a] font-bold text-lg">Alege sezlong</p>
              <button onClick={() => setShowMap(false)} className="text-black/40 p-1">
                <X className="w-5 h-5" />
              </button>
            </div>

            <div className="flex items-center gap-4 text-[10px] text-black/40 mb-4">
