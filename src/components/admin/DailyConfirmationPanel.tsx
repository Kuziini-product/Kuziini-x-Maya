              ...
              >
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    <Umbrella className="absolute left-2.5 top-2 w-3.5 h-3.5 text-white/30" />
                    <input
                      type="text"
                      ...
                      className="w-full bg-white/5 border border-white/10 pl-8 pr-2 py-1.5 text-white text-xs outline-none focus:border-[#C9AB81]/50 placeholder:text-white/20"
                    />
                  </div>
                  <button
                    onClick={() =>
